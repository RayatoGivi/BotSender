...
async def send_message():
    channel = client.get_channel(1208372349393575966)  # Замените CHANNEL_ID на ID канала, куда хотите отправлять сообщения
    while True:
...
client.run('MTIwOTg5NTkxNDMxNjIzODkwOA.G59gQm.cNUJwJGYlnMtLfD22W8kgHuwPhFOoFkoJ8BQi8') # Токен вашего бота